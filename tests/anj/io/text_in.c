...
ANJ_UNIT_TEST(text_in, string_in_parts) {
    ...
    ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, TEST_STRING_2,
...
#define TEST_NUM_FAIL(TypeBitmask, Val)                                     \
    TEST_NUM_COMMON(Val, anj_data_type_t type_bitmask = TypeBitmask;        \
                    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
                                                       &value, &path),      \
                              _ANJ_IO_ERR_FORMAT);)

#define TEST_I64(Val)                                                       \
    TEST_NUM_COMMON(Val, anj_data_type_t type_bitmask = ANJ_DATA_TYPE_INT;  \
                    ASSERT_OK(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
                                                       &value, &path));     \
                    ASSERT_EQ(type_bitmask, ANJ_DATA_TYPE_INT);             \
                    ASSERT_TRUE(anj_uri_path_equal(                         \
                            path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));       \
...
#define TEST_I64_FAIL(Val) TEST_NUM_FAIL(ANJ_DATA_TYPE_INT, Val)

ANJ_UNIT_TEST(text_in, i64) {
    TEST_I64(514);
    TEST_I64(0);
    TEST_I64(-1);
    TEST_I64(2147483647);
...
// constant
ANJ_UNIT_TEST(text_in, smallest_i64) {
...
ANJ_UNIT_TEST(text_in, int_started_not_finished) {
...
ANJ_UNIT_TEST(text_in, int_not_started_not_finished) {
...
ANJ_UNIT_TEST(text_in, i64_in_parts) {
    char data_1[] = "-214";
    char data_2[] = "7483649";
    ...
    // second feed
    ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, data_2, strlen(data_2), true));
    ASSERT_OK(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path));
    ASSERT_EQ(type_bitmask, ANJ_DATA_TYPE_INT);
    ASSERT_TRUE(anj_uri_path_equal(path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));
...
#define TEST_U64(Val)                                                       \
    TEST_NUM_COMMON(Val, anj_data_type_t type_bitmask = ANJ_DATA_TYPE_UINT; \
                    ASSERT_OK(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
                                                       &value, &path));     \
                    ASSERT_EQ(type_bitmask, ANJ_DATA_TYPE_UINT);            \
                    ASSERT_TRUE(anj_uri_path_equal(                         \
                            path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));       \
...
// integer constant
ANJ_UNIT_TEST(text_in, biggest_u64) {
...
ANJ_UNIT_TEST(text_in, u64_in_parts) {
    char data_1[] = "429";
    char data_2[] = "4967295";
    TEST_ENV(data_1, MAKE_TEST_RESOURCE_PATH(5), false);
    anj_data_type_t type_bitmask = ANJ_DATA_TYPE_UINT;
...
#define TEST_DOUBLE(Val)                                                      \
    TEST_NUM_COMMON(Val, anj_data_type_t type_bitmask = ANJ_DATA_TYPE_DOUBLE; \
                    ASSERT_OK(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask,   \
                                                       &value, &path));       \
                    ASSERT_EQ(type_bitmask, ANJ_DATA_TYPE_DOUBLE);            \
                    ASSERT_TRUE(anj_uri_path_equal(                           \
                            path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));         \
...
#define TEST_DOUBLE_FAIL(Val) TEST_NUM_FAIL(ANJ_DATA_TYPE_DOUBLE, Val)

ANJ_UNIT_TEST(text_in, f64) {
    TEST_DOUBLE(0);
    TEST_DOUBLE(0.0);
    TEST_DOUBLE(1);
    TEST_DOUBLE(1.0);
    ...
    TEST_DOUBLE(4.223e+10);
    TEST_DOUBLE(4.223e-10);
    TEST_DOUBLE(-3.26e+15);
    TEST_DOUBLE_FAIL(wat);
}

ANJ_UNIT_TEST(text_in, double_in_parts) {
    char data_1[] = "1.312";
    char data_2[] = "5000";
    TEST_ENV(data_1, MAKE_TEST_RESOURCE_PATH(5), false);
...
#define TEST_BOOL(Val)                                                      \
    TEST_NUM_COMMON(Val, anj_data_type_t type_bitmask = ANJ_DATA_TYPE_BOOL; \
                    ASSERT_OK(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
                                                       &value, &path));     \
                    ASSERT_EQ(type_bitmask, ANJ_DATA_TYPE_BOOL);            \
                    ASSERT_TRUE(anj_uri_path_equal(                         \
                            path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));       \
                    ANJ_UNIT_ASSERT_EQUAL(value->bool_value, Val);          \
                    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
                                                       &value, &path),      \
                              _ANJ_IO_EOF);                                 \
                    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
...
#define TEST_BOOL_FAIL(Str)                                             \
    do {                                                                \
        ...
        anj_data_type_t type_bitmask = ANJ_DATA_TYPE_BOOL;              \
...
ANJ_UNIT_TEST(text_in, boolean_not_finished_afterwards) {
    ...
    ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, "", 0, false));
    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path),
              _ANJ_IO_WANT_NEXT_PAYLOAD);
    ASSERT_NULL(value);
    ASSERT_TRUE(anj_uri_path_equal(path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));
...
#define TEST_OBJLNK(Oid, Iid)                                                  \
    TEST_OBJLNK_COMMON(#Oid ":" #Iid,                                          \
                       ...
                       ASSERT_OK(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
                                                          &value, &path));     \
                       ASSERT_EQ(type_bitmask, ANJ_DATA_TYPE_OBJLNK);          \
                       ASSERT_TRUE(anj_uri_path_equal(                         \
                               path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));       \
                       ANJ_UNIT_ASSERT_EQUAL(value->objlnk.oid, Oid);          \
                       ANJ_UNIT_ASSERT_EQUAL(value->objlnk.iid, Iid);          \
                       ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
                                                          &value, &path),      \
                                 _ANJ_IO_EOF);                                 \
                       ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, \
...
ANJ_UNIT_TEST(text_in, objlnk_in_parts) {
    char data_1[] = "6553";
    char data_2[] = "5:2137";
    TEST_ENV(data_1, MAKE_TEST_RESOURCE_PATH(5), false);
    anj_data_type_t type_bitmask = ANJ_DATA_TYPE_OBJLNK;
...
ANJ_UNIT_TEST(text_in, 8_bytes_in) {
...
ANJ_UNIT_TEST(text_in, 16_bytes_in) {
...
ANJ_UNIT_TEST(text_in, 16_bytes_in_parts) {
    ...
    // second feed
    ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, data_in_2,
    ...
    ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, data_in_3,
    ...
    // fourth feed
    ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, data_in_4,
...
#define FIRST_FEED_WITH_UP_TO_3_CHARS(TestName, DataIn1, DataIn2)              \
    ANJ_UNIT_TEST(text_in, TestName) {                                         \
        ...
        ASSERT_EQ(type_bitmask, ANJ_DATA_TYPE_BYTES);                          \
        ASSERT_TRUE(                                                           \
                anj_uri_path_equal(path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));   \
        ASSERT_NULL(value);                                                    \
                                                                               \
        ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, data_in_2,                 \
...
ANJ_UNIT_TEST(text_in, provide_chars_one_by_one) {
    ...
    while (i < sizeof(data_in) - 1) {
        ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, &data_in[i++], 1, false));
        result = _anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path);
        ASSERT_TRUE(anj_uri_path_equal(path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));
        path = NULL;
        if (i % 4 != 0) {
            ASSERT_EQ(result, _ANJ_IO_WANT_NEXT_PAYLOAD);
            ASSERT_NULL(value);
        } else {
            ASSERT_OK(result);
            ASSERT_EQ(value->bytes_or_string.full_length_hint, 0);
    ...
    ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, "", 0, true));
    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path), 0);
    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path),
              _ANJ_IO_EOF);
}

ANJ_UNIT_TEST(text_in, feeding_after_padded) {
    ...
    ASSERT_EQ(value->bytes_or_string.full_length_hint, 0);
    ASSERT_EQ_BYTES(value->bytes_or_string.data, data_out);
    ASSERT_OK(_anj_io_in_ctx_feed_payload(&ctx, data_in_2, strlen(data_in_2),
                                          false));
    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path),
              _ANJ_IO_ERR_FORMAT);
}

ANJ_UNIT_TEST(text_in, padding_after_padding) {
...
ANJ_UNIT_TEST(text_in, test_diambiguation) {
    static char data_in[] = "AgEDB/8AMSUkJicoKTAxAA==";
    TEST_ENV(data_in, MAKE_TEST_RESOURCE_PATH(5), true);
...
ANJ_UNIT_TEST(text_in, int_no_data_with_payload_finished) {
...
ANJ_UNIT_TEST(text_in, uint_no_data_with_payload_finished) {
    TEST_ENV("", MAKE_TEST_RESOURCE_PATH(5), true);
    anj_data_type_t type_bitmask = ANJ_DATA_TYPE_UINT;
    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path),
              _ANJ_IO_ERR_FORMAT);
...
ANJ_UNIT_TEST(text_in, bool_no_data_with_payload_finished) {
    TEST_ENV("", MAKE_TEST_RESOURCE_PATH(5), true);
    anj_data_type_t type_bitmask = ANJ_DATA_TYPE_BOOL;
    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path),
              _ANJ_IO_ERR_FORMAT);
...
ANJ_UNIT_TEST(text_in, objlnk_no_data_with_payload_finished) {
    TEST_ENV("", MAKE_TEST_RESOURCE_PATH(5), true);
    anj_data_type_t type_bitmask = ANJ_DATA_TYPE_OBJLNK;
    ASSERT_EQ(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path),
              _ANJ_IO_ERR_FORMAT);
...
ANJ_UNIT_TEST(text_in, time_no_data_with_payload_finished) {
    TEST_ENV("", MAKE_TEST_RESOURCE_PATH(5), true);
...
ANJ_UNIT_TEST(text_in, bytes_no_data_with_payload_finished) {
    TEST_ENV("", MAKE_TEST_RESOURCE_PATH(5), true);
    anj_data_type_t type_bitmask = ANJ_DATA_TYPE_BYTES;
    ASSERT_OK(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path));
    ASSERT_TRUE(anj_uri_path_equal(path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));
...
ANJ_UNIT_TEST(text_in, string_no_data_with_payload_finished) {
    TEST_ENV("", MAKE_TEST_RESOURCE_PATH(5), true);
    anj_data_type_t type_bitmask = ANJ_DATA_TYPE_STRING;
    ASSERT_OK(_anj_io_in_ctx_get_entry(&ctx, &type_bitmask, &value, &path));
    ASSERT_TRUE(anj_uri_path_equal(path, &ANJ_MAKE_RESOURCE_PATH(3, 4, 5)));
