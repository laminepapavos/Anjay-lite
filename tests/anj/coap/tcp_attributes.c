...
ANJ_UNIT_TEST(attr_decode_tcp, decode_write_attributes) {
    uint8_t MSG[] =
            "\xD1"                             // msg_len 13, tkl 1
            "\x49"                             // extended length 86
            "\x03"                             // PUT
            "\x12"                             // token
...
ANJ_UNIT_TEST(attr_decode_tcp, decode_write_attributes_empty_1) {
    uint8_t MSG[] =
            "\xD1"                                 // msg_len 13, tkl 1
            "\x02"                                 // extended length 15
            "\x03"                                 // PUT
            "\x12"                                 // token
...
ANJ_UNIT_TEST(attr_decode_tcp, decode_write_attributes_empty_2) {
    uint8_t MSG[] = "\x61"                     // msg_len 6, tkl 1
                    "\x03"                     // PUT
                    "\x12"                     // token
...
ANJ_UNIT_TEST(attr_decode_tcp, decode_write_attributes_empty_3) {
    uint8_t MSG[] = "\xA1"                     // msg_len 10, tkl 1
                    "\x03"                     // PUT
                    "\x12"                     // token
                    "\xD4\x02\x70\x6d\x61\x78" // URI_QUERY 15 pmax
...
ANJ_UNIT_TEST(attr_decode_tcp, decode_write_attributes_incorrect_attribute) {
    uint8_t MSG[] = "\x71"                         // msg_len 7, tkl 1
                    "\x03"                         // PUT
                    "\x12"                         // token
    ...
    ANJ_UNIT_ASSERT_EQUAL(_anj_coap_decode_tcp(MSG, sizeof(MSG) - 1, &out_data,
                                               &offset),
                          _ANJ_ERR_MALFORMED_MESSAGE);
}

ANJ_UNIT_TEST(attr_decode_tcp, decode_write_attributes_incorrect_attribute_2) {
    uint8_t MSG[] =
            "\x91"                                 // msg_len 9, tkl 1
            "\x03"                                 // PUT
            "\x12"                                 // token
...
ANJ_UNIT_TEST(attr_decode_tcp, decode_write_attributes_size_error) {
    uint8_t MSG[] =
            "\xD1" // msg_len 13, tkl 1
            "\x2B" // extended length 56
            "\x03" // PUT
            "\x12" // token
